    ...
    render() {
        return <div className="container-more">
                    ...
                    <div className="bio-text">
                        ...
                        <br/>
                        <br/>
                        <img src="/media/butt1.png" className="bio-text-img1" />
                        <img src="/media/butt2.png" className="bio-text-img2" />
                        <img src="/media/butt3.png" className="bio-text-img3" />
                    </div>
                    <video className="bio-video" controls src={"/media/bio.mp4"} type={"video/mp4"}
                           onLoadedData={this.finishLoading}>Sorry
                    </video>
            <div className="bio-text small marg-top">
                ...
                <br/> All the images come from the Biodiversity Heritage Library. Available at: https://www.flickr.com/photos/biodivlibrary/
            </div>
