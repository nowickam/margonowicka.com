export const data = [
    ...
    },
    {
        ...
        img: "",
        text: [
            "Czas (Cellular Automaton Sequencer) is a sonification of the pattern generated by a cellular automaton. Czas' focus is on transparency - the electronics on display, the pattern on the small sceen. Every click of the button randomly reshuffles the generation rules and their quickly disappearing result seems to be better understood when listened to.",
